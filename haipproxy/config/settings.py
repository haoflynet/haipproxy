...
TEMP_TMALL_QUEUE = 'haipproxy:tmall:temp'
...
VALIDATED_TMALL_QUEUE = 'haipproxy:validated:tmall'
...
TTL_TMALL_QUEUE = 'haipproxy:ttl:tmall'
...
SPEED_TMALL_QUEUE = 'haipproxy:speed:tmall'
