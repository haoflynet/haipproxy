...
from ..config.settings import (
    ...
    SPEED_ZHIHU_QUEUE, TEMP_TMALL_QUEUE, VALIDATED_TMALL_QUEUE, TTL_TMALL_QUEUE, SPEED_TMALL_QUEUE)
...
VALIDATOR_TASKS = [
    ...
    },
    {
        ...
        'resource': VALIDATED_TMALL_QUEUE,
        'interval': 5,
        'enable': 1,
    }
]
